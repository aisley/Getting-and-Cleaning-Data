...
write.table(FinalData, file="./HumanActivity.txt", col.names=TRUE, row.names = FALSE, sep = " ")
...
write.table(TidyData, file="./AvgHumanActivity.txt", col.names=TRUE, row.names = FALSE, sep = " ")
